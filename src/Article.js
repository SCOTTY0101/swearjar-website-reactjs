...
function Article() {
    return(
      ...
      <div className="article-container">
        ...
        <img src="image/cloud.svg" alt="cloud" id="xs-cloud"/></a></button><span className="br"></span>
    ...
    <article className="article">
      <div className="article-container">
        ...
        <img className="ball" src="image/ball.png"  alt="magic decision ball" />
      ...
      <h3 id="sponcer">Sponsors & Website credits : <img src="image/favicon-32x32.png" alt="sJs"></img></h3>
    </article>
